    ...
    return (
        <nav className={styles.wrapper}>
            <div className={styles.navbar_left}>
                <a href="https://banhang.shopee.vn/account/signin?next=%2F" target="_blank" className={styles.navbar_left_item}>Kênh người bán</a>
                <a href="/" className={styles.navbar_left_item}>Trờ thành người bán Shopee</a>
                <div className={styles.download_drawer}>
                    <a href="https://shopee.vn/web" target="_blank" className={styles.navbar_left_item}>Tải ứng dụng</a>
            ...
            <div className={styles.navbar_right}>
                ...
                <div className={`${styles.navbar_right_item} ${styles.lang_hover}`}>
                    ...
                    <div className={styles.navbar_right_hover}>
                        ...
                        <a href="" className={styles.navbar_right_lang}>English</a>
                    </div>
                </div>
